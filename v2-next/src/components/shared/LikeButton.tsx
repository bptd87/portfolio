    ...
    <div className="flex items-center gap-2">
      <motion.button
        ...
        className={`group relative flex items-center justify-center rounded-full transition-all ${compact
          ...
          : 'backdrop-blur-md bg-white/80 dark:bg-white/5 hover:bg-white dark:hover:bg-white/10 border border-neutral-200 dark:border-white/10'
          } ${sizeClasses[size]} ${isLiked ? 'text-rose-500' : 'text-neutral-600 dark:text-white'}`}
        whileTap={{ scale: 0.9 }}
