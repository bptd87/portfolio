...
type ManagerType = 'dashboard' | 'scenic' | 'experiential' | 'rendering' | 'models' | 'articles' | 'news' | 'tutorials' | 'comments' | 'links' | 'directory' | 'vault' | 'categories' | 'collaborators' | 'settings' | 'about' | 'resume' | 'analytics' | 'api-status' | 'redirects' | 'media';
...
const navCategories = [
...

  {
    ...
    items: ['scenic', 'experiential', 'rendering', 'models', 'articles', 'news', 'tutorials', 'comments']
  },
  {
    id: 'assets',
    label: 'Galleries & Assets',
    items: ['media', 'directory', 'vault']
  },
  {
    id: 'site',
