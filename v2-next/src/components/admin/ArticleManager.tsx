...
import { AIExcerptGenerator } from './AIExcerptGenerator';
...
export function ArticleManager() {
  ...
  const handleEdit = (article: any) => {
    ...
    methods.reset({
      ...
      focusPoint: article.focusPoint || article.cover_image_focal_point || { x: 50, y: 50 },
    });
                ...
                <div className={activeTab === 'media' ? 'block space-y-8' : 'hidden'}>
                   <div className="bg-zinc-900 rounded-xl p-6 border border-zinc-800 space-y-6">
                    ...
                    <ImageUploaderWithFocalPoint
                      ...
                      onChange={(url, point) => {
                        methods.setValue('coverImage', url);
                        if (point) {
                          methods.setValue('focusPoint', point);
                        }
                      }}
                      bucketName="blog"
                    />
