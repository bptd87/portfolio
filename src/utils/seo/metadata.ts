...
export const DEFAULT_METADATA = {
  ...
  siteUrl: typeof window !== "undefined"
    ...
    : "https://brandonptdavis.com",
  author: "Brandon PT Davis",
  twitterHandle: "@brandonptdavis", // Update if you create a Twitter/X account
  defaultOgImage: "/og-default.jpg",
  defaultDescription:
    "Award-winning scenic designer creating immersive theatrical experiences and educational resources for theatre designers and creative professionals.",
...
export const PAGE_METADATA: Record<string, PageMetadata> = {
  ...
  home: {
    ...
    description:
      "Award-winning scenic designer creating immersive theatrical experiences. Explore scenic design work, educational resources, and comprehensive design tools for theatre professionals.",
    keywords: [
      "scenic design",
      "theatre design",
      "set design",
  ...
  about: {
    ...
    description:
      "Learn about my journey as a scenic designer, combining theatrical artistry with technical innovation to create immersive experiences for theatre and opera.",
