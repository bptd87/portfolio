                  ...
                  <div key={tab.label}>
                    {hasSubmenu(tab) ? (
                          ...
                          <div className="ml-4 space-y-1 mt-1">
                            {tab.submenu.map((item) => (
                              <button
                                ...
                                className={`w-full px-4 py-2 text-left text-xs font-pixel tracking-[0.1em] rounded transition-all duration-200 ${
                                  isDark
                      ...
                      <button
                        ...
                        className={`w-full px-4 py-2 text-left font-pixel text-xs tracking-[0.12em] rounded transition-all duration-200 ${
                          isDark
                            ? 'text-white/70 hover:text-white hover:bg-white/10'
                            : 'text-neutral-700 hover:text-neutral-900 hover:bg-neutral-800/10'
                        }`}
