...
export function DesktopNav({ onNavigate, currentPage }: DesktopNavProps) {
  ...
  const backgroundClass = (isHovered || mobileMenuOpen || searchOpen || activeDropdown)
    ? (isNavDark
      ? 'bg-neutral-900/40 nav--dark backdrop-blur-xl backdrop-saturate-150'
      : 'bg-white/80 nav--light backdrop-blur-xl backdrop-saturate-150')
    : 'bg-transparent';
            ...
            <div className="flex-shrink-0 flex items-center">
              ...
              >
                ...
                <div className="flex flex-col items-start justify-end h-full">
                  ...
                  <div className={[
                    'text-[0.65rem] font-medium tracking-[0.3em] uppercase opacity-70 leading-none',
                    isNavDark ? 'text-white/80' : 'text-neutral-600'
                  ].join(' ')}>
                    Scenic Designer
                  </div>
                </div>
                    ...
                    >
                      <button
                        ...
                        className={[
                          ...
                          active
                            ? isNavDark ? 'text-white' : 'text-neutral-900'
                            : isNavDark ? 'text-white/80' : 'text-neutral-700',
                        ].join(' ')}
                        style={{ fontSize: '11px' }}
                      >
