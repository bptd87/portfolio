...
const MAIN_SECTIONS = [
  {
    ...
    image: 'https://kleljpvnebosqmtfnfgk.supabase.co/storage/v1/object/public/projects/mdq/MDQ_Model_Perkins.jpg',
    route: 'scenic-studio',
    comingSoon: false,
  },
  {
    ...
    image: 'https://kleljpvnebosqmtfnfgk.supabase.co/storage/v1/object/public/projects/mdq/MDQ_WhiteModel.jpg',
    route: 'app-studio',
    comingSoon: false,
  },
  {
    ...
    image: 'https://zuycsuajiuqsvopiioer.supabase.co/storage/v1/object/public/make-74296234-images/images/3D%20Models.png',
    route: 'scenic-vault',
    comingSoon: false,
  },
  {
...
const QUICK_TOOLS = [
  { 
    ...
    image: 'https://images.unsplash.com/photo-1544704784-59bcc978c9c4?w=400&h=300&fit=crop',
  },
  { 
    name: 'Dimension Reference', 
    route: 'dimension-reference',
    image: 'https://images.unsplash.com/photo-1670222061552-c273834aee0c?w=400&h=300&fit=crop',
  },
  { 
    name: 'Paint Calculator', 
    route: 'rosco-paint-calculator',
    image: 'https://images.unsplash.com/photo-1660861472949-a26dfbf0b0f1?w=400&h=300&fit=crop',
  },
  { 
    name: 'Design History', 
    route: 'design-history-timeline',
    image: 'https://images.unsplash.com/photo-1721244653652-268631ec049a?w=400&h=300&fit=crop',
  },
  { 
    name: 'Classical Orders', 
    route: 'classical-architecture-guide',
    image: 'https://images.unsplash.com/photo-1632731187075-11c50d94bd5a?w=400&h=300&fit=crop',
  },
  { 
    name: 'Paint Finder', 
    route: 'commercial-paint-finder',
    image: 'https://images.unsplash.com/photo-1560121361-3968dbf2b749?w=400&h=300&fit=crop',
  },
];
