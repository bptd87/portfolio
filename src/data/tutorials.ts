...
export const DEFAULT_CATEGORIES: TutorialCategory[] = [
  {
    id: "quick-tips",
    name: "Quick Tips",
    description: "Short, focused tutorials on specific techniques",
  },
  {
    id: "walkthroughs",
    name: "Project Walkthroughs",
    description: "Complete project overviews and design process",
  },
  {
    id: "3d-modeling",
...
export const TUTORIALS: Tutorial[] = [
  {
    ...
    description:
      "Complete process of turning a 3D model into clear 2D drafting for construction drawings. Learn viewports, rendering styles, and professional documentation.",
  ...
  },
  {
    ...
    description:
      "Go behind the scenes of my 2024 scenic design for Footloose at Stephens College. Built in Vectorworks and rendered in Twinmotion, this walkthrough explores how movement and energy informed each design choice.",
  ...
  },
  {
    ...
    description:
      "Explore the Other World in this Twinmotion walkthrough of The Coraline Experience, a collaborative MFA Design project at UC Irvine that brought together scenic, lighting, costume, sound, and stage management.",
    category: "walkthroughs",
    duration: "2:10",
  ...
  },
  {
    ...
    description:
      "An outdoor production reimagined for a pandemic era—this scenic design for Lysistrata balanced ancient ritual with contemporary safety.",
    category: "walkthroughs",
    duration: "1:45",
  ...
  },
  {
    ...
    description:
      "Learn how to light, frame, and render your 3D model in Vectorworks using cameras and Renderworks styles. This quick tutorial covers spotlight setup, camera views, and exporting high-quality image files for presentations.",
    category: "quick-tips",
    duration: "10:45",
    thumbnail: "https://img.youtube.com/vi/Jp4eG5n3esc/maxresdefault.jpg",
    ...
    resources: [
      {
        name: "Watch on YouTube",
        description:
          "Follow along with the full step-by-step camera and rendering tutorial",
  ...
  },
  {
    ...
    description:
      "Learn how to set up a 24x36 sheet layer and export it to PDF in Vectorworks—without Adobe PDF or a plotter. Ideal for printing scenic drafting plates on standard systems.",
    category: "quick-tips",
    duration: "3:36",
    thumbnail: "https://img.youtube.com/vi/Gd9_hB5USkQ/maxresdefault.jpg",
  ...
  },
  {
    ...
    description:
      "Learn how to trace and scale trim profiles in Vectorworks using the Polyline Tool. This tutorial covers vertex modes, symbol creation, and scaling based on real-world data for accurate 2D drafting in scenic design.",
    category: "quick-tips",
    duration: "6:20",
    thumbnail: "https://img.youtube.com/vi/EZB5O-Wmsk4/maxresdefault.jpg",
