...
// Import card images
import mdqCardImage from 'figma:asset/2c1c79039cfd4381f506e8c95ec032cea353ba13.png';
import muchAdoCardImage from 'figma:asset/4e3beab39841f6cce072c59b365308d5507baf12.png';

export interface Project {
  id: string;
  title: string;
  category: 'Scenic Design' | 'Experiential Design' | 'Rendering & Visualization' | 'Design Documentation';
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    featured: true,
    description: 'Scenic design for Shakespeare\'s romantic comedy set in the American Southwest, featuring live bluegrass music.',
    credits: {
      director: 'Eli Simon',
  ...
  },
  {
    ...
    year: 2025,
    featured: true,
    description: 'Scenic design for Shakespeare\'s problem play, exploring themes of class, gender, and agency.',
    credits: {
      director: 'Rob Salas',
      scenicDesigner: 'Brandon PT Davis',
  ...
  },
  {
    ...
    year: 2025,
    featured: true,
    description: 'Scenic design for the world premiere exploring the life and martyrdom of Archbishop Óscar Romero.',
    credits: {
  ...
  },
  {
    ...
    year: 2025,
    featured: false,
    description: 'Scenic design for the musical comedy about two Wisconsin fishermen on a frozen lake.',
    credits: {
      director: 'Dan Klarer',
      scenicDesigner: 'Brandon PT Davis',
  ...
  },
  {
    ...
    year: 2024,
    featured: false,
    description: 'Scenic design for the satirical musical comedy about a dystopian water shortage.',
    credits: {
  ...
  },
  {
    ...
    year: 2024,
    featured: false,
    description: 'Scenic design for Neil Simon\'s romantic comedy about newlyweds in a New York City walk-up.',
    credits: {
  ...
  },
  {
    ...
    year: 2024,
    featured: false,
    description: 'Scenic design for the musical adaptation of the beloved body-swap story.',
    credits: {
  ...
  },
  {
    ...
    year: 2023,
    featured: false,
    description: 'Scenic design for Marc Camoletti\'s French farce about an American architect juggling three stewardess fiancées.',
    credits: {
  ...
  },
  {
    ...
    year: 2022,
    featured: false,
    description: 'Scenic design for the jukebox musical featuring the music of The Go-Go\'s.',
    credits: {
  ...
  },
  {
    ...
    year: 2022,
    featured: false,
    description: 'Scenic design for Shakespeare\'s comedy set in Windsor, England.',
    credits: {
  ...
  },
  {
    ...
    year: 2021,
    featured: false,
    description: 'Scenic design for J.B. Priestley\'s moral thriller about class and responsibility.',
    credits: {
      director: 'Lex Leigh',
      scenicDesigner: 'Brandon PT Davis',
  ...
  },
  {
    ...
    year: 2022,
    featured: false,
    description: 'Scenic design for the Sondheim musical comedy set in ancient Rome.',
    credits: {
  ...
  },
  {
    ...
    year: 2021,
    featured: false,
    description: 'Scenic design for the bilingual play celebrating the power of literacy and libraries.',
    credits: {
  ...
  },
  {
    ...
    location: 'El Paso, TX',
    year: 2021,
    cardImage: 'https://zuycsuajiuqsvopiioer.supabase.co/storage/v1/object/public/portfolio/Lysistrata/Lyistrata%20Rendering%20-%20Vectorworks%20-%20Brandon%20PT%20Davis%20-%203.jpg',
    featured: false,
    description: 'First live performance on campus during the pandemic, transforming a courtyard into a safe outdoor theatre with socially distanced audience pods.',
    credits: {
  ...
  },
  {
    ...
    location: 'Concord, CA',
    year: 2021,
    cardImage: 'https://zuycsuajiuqsvopiioer.supabase.co/storage/v1/object/public/portfolio/Park%20&%20Shop/Pak%20&%20Shop%20Rendering%20by%20Brandon%20PT%20Davis%20-%202.jpeg',
    featured: false,
    description: 'Mid-century beautification initiative for a landmark retail center, celebrating heritage while reimagining future through concept renderings and visualization.',
    credits: {
      scenicDesigner: 'Brandon PT Davis',
  ...
  },
  {
    ...
    location: 'Irvine, CA',
    year: 2024,
    cardImage: 'https://zuycsuajiuqsvopiioer.supabase.co/storage/v1/object/public/portfolio/New%20Swan%20Venue%20File/Rendering_New+Swan+Venue_1%20Large%20Large.jpeg',
    featured: false,
    description: 'Complete Vectorworks venue file for the New Swan Theatre outdoor amphitheater.',
    credits: {
      scenicDesigner: 'Brandon PT Davis'
    }
  },
  {
    ...
    year: 2020,
    featured: false,
    description: 'Scenic design for Margaret Atwood\'s retelling of The Odyssey from Penelope\'s perspective.',
    credits: {
  ...
  },
  {
    ...
    year: 2020,
    featured: false,
    description: 'Scenic design for Sondheim\'s musical about marriage and relationships in New York City.',
    credits: {
  ...
  },
  {
    ...
    year: 2019,
    featured: false,
    description: 'Scenic design for the 1950s musical comedy about labor relations and romance.',
    credits: {
  ...
  },
  {
    ...
    year: 2019,
    featured: false,
    description: 'Scenic design for the California premiere about peace activist Brian Haw.',
    credits: {
  ...
  },
  {
    ...
    year: 2018,
    cardImage: 'https://zuycsuajiuqsvopiioer.supabase.co/storage/v1/object/public/portfolio/Red%20Line%20Cafe/Red%20Line%20Cafe%20-%20Rendering%20in%20Vectorworks%20by%20Brandon%20PT%20Davis%20-%201.jpeg',
    featured: true,
    description: 'Chicago-inspired café concept blending transit culture, architectural grit, and civic identity into a cohesive hospitality experience celebrating the city\'s character.',
    credits: {
  ...
  },
  {
    ...
    year: 2012,
    featured: false,
    description: 'Scenic design for Patrick Hamilton\'s Victorian thriller (also known as Gaslight).',
    credits: {
  ...
  },
  {
    ...
    year: 2010,
    featured: false,
    cardImage: 'https://zuycsuajiuqsvopiioer.supabase.co/storage/v1/object/public/portfolio/All%20My%20Sons/All%20My%20Sons_4.jpg',
    description: 'For All My Sons, I built a scenic world that embodies the idealized postwar "American Dream": a charming home with a wide porch and a neat, expansive backyard—a warm, welcoming environment that feels safe, comfortable, and complete.',
    credits: {
...
export const getRecentProjects = (count: number = 3) => {
  if (!_recentCache.has(count)) {
    _recentCache.set(count, [...projects].sort((a, b) => b.year - a.year).slice(0, count));
  }
...
export const getAdjacentProjects = (currentId: string) => {
  ...
  return {
    ...
    next: currentIndex < sameCategoryProjects.length - 1 ? sameCategoryProjects[currentIndex + 1] : null
  };
};
